...
assert(index.includes('1.0.24'),'index.html não está na versão 1.0.24');
assert(config.includes("version: '1.0.24'"),'config.js não está na versão 1.0.24');
...
assert(sw.includes("borion-cnpj-v1.0.24"),'cache PWA não está em 1.0.24');
...
assert(index.includes('js/app.js?v=1.0.24'),'index.html não força app.js 1.0.24');
assert(index.includes("service-worker.js?v=1.0.24"),'index.html não força service worker 1.0.24');

if(!process.exitCode) console.log('BORION CNPJ 1.0.24 validado com sucesso.');
