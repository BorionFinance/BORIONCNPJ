...
assert(index.includes('1.0.13'),'index.html não está na versão 1.0.13');
assert(config.includes("version: '1.0.13'"),'config.js não está na versão 1.0.13');
...
assert(fs.readFileSync('service-worker.js','utf8').includes("borion-cnpj-v1.0.13"),'cache PWA não está em 1.0.13');

if(!process.exitCode) console.log('BORION CNPJ 1.0.13 validado com sucesso.');
