...
assert(index.includes('1.0.12'),'index.html não está na versão 1.0.12');
assert(config.includes("version: '1.0.12'"),'config.js não está na versão 1.0.12');
...
assert(fs.readFileSync('service-worker.js','utf8').includes("borion-cnpj-v1.0.12"),'cache PWA não está em 1.0.12');

if(!process.exitCode) console.log('BORION CNPJ 1.0.12 validado com sucesso.');
