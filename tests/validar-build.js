...
assert(index.includes('1.0.5'),'index.html não está na versão 1.0.5');
assert(config.includes("version: '1.0.5'"),'config.js não está na versão 1.0.5');
...
if(!process.exitCode) console.log('BORION CNPJ 1.0.5 validado com sucesso.');
