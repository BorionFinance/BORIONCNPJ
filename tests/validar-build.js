...
assert(index.includes('1.0.20'),'index.html não está na versão 1.0.20');
assert(config.includes("version: '1.0.20'"),'config.js não está na versão 1.0.20');
...
assert(app.includes('Drive._pullOnceV118'),'carregamento seguro v1.0.20 ausente');
assert(app.includes('Drive.writeCanonicalV118'),'gravação canônica v1.0.20 ausente');
...
assert(sw.includes("borion-cnpj-v1.0.20"),'cache PWA não está em 1.0.20');
if(!process.exitCode) console.log('BORION CNPJ 1.0.20 validado com sucesso.');
