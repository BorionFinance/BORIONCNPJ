...
assert(index.includes('1.0.11'),'index.html não está na versão 1.0.11');
assert(config.includes("version: '1.0.11'"),'config.js não está na versão 1.0.11');
...
assert(fs.readFileSync('service-worker.js','utf8').includes("borion-cnpj-v1.0.11"),'cache PWA não está em 1.0.11');

if(!process.exitCode) console.log('BORION CNPJ 1.0.11 validado com sucesso.');
