const CACHE='borion-cnpj-v1.0.13';
const CORE=['./','./index.html','./manifest.webmanifest?v=1.0.13','./css/borion-7.6.2.css?v=1.0.13','./css/cnpj.css?v=1.0.13','./js/config.js?v=1.0.13','./js/app.js?v=1.0.13','./borion-cnpj-v111-emblem.png','./borion-cnpj-v111-watermark.png','./borion-cnpj-v111-icon-192.png','./borion-cnpj-v111-icon-512.png','./borion-cnpj-v111-favicon-32.png','./borion-cnpj-v111-apple-touch-icon.png','./borion-cnpj-v111.ico'];
