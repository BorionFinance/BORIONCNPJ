...
assert(index.includes('1.0.21'),'index.html não está na versão 1.0.21');
assert(config.includes("version: '1.0.21'"),'config.js não está na versão 1.0.21');
...
assert(app.includes('Drive._pullOnceV118'),'carregamento seguro v1.0.21 ausente');
assert(app.includes('Drive.writeCanonicalV118'),'gravação canônica v1.0.21 ausente');
...
assert(sw.includes("borion-cnpj-v1.0.21"),'cache PWA não está em 1.0.21');
if(!process.exitCode) console.log('BORION CNPJ 1.0.21 validado com sucesso.');
