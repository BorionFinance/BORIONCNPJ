...
assert(index.includes('1.0.18'),'index.html não está na versão 1.0.18');
assert(config.includes("version: '1.0.18'"),'config.js não está na versão 1.0.18');
...
assert(app.includes('Drive._pullOnceV118'),'carregamento seguro v1.0.18 ausente');
assert(app.includes('Drive.writeCanonicalV118'),'gravação canônica v1.0.18 ausente');
...
assert(sw.includes("borion-cnpj-v1.0.18"),'cache PWA não está em 1.0.18');
if(!process.exitCode) console.log('BORION CNPJ 1.0.18 validado com sucesso.');
